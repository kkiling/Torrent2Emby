...
// GetTorrentFilesInfo получение информации о файлах раздачи
func (s *Service) GetTorrentFilesInfo(ctx context.Context, content *VideoContent) error {
	// TODO: Снятие с паузы торрент раздачи
	// TODO: ожидание получения информации о файлах
	// TODO: Сохранение информации о списке файлов
	panic("implement me")
}

// PreparingFileMatches формирование соответствия серий сезона сериала или фильма с файлами раздачи
func (s *Service) PreparingFileMatches(ctx context.Context, content *VideoContent) error {
	// TODO: Формирование соответствия серий сезона сериала или фильма с файлами раздачи
...
func (s *Service) ChoseFileMatches(ctx context.Context, content *VideoContent) error {
	// TODO: Сохранение информации о соответствии файлов
	// TODO: Переход на следующий шаг
	panic("implement me")
}
...
func (s *Service) WaitingTorrentDownloadComplete(ctx context.Context, content *VideoContent) error {
	// TODO: получение информации о скачивании раздачи
	// TODO: Обновление прогресса и сохранения его
	// TODO: Ожидание окончания скачивания
	// TODO: Если файлы нужно обрабатывать - Переход на следующий шаг mkvmerge
	// TODO: Если не нужно - Переходим на шаг копирования файлов в медиасервер
	panic("implement me")
}
