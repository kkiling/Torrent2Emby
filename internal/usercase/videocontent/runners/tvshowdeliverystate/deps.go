...
type ContentDelivery interface {
	...
	GetMagnetLink(ctx context.Context, params delivery.GetMagnetLinkParams) (*delivery.MagnetInfo, error)
	...
	CreateContentCatalogs(ctx context.Context, params delivery.CreateContentCatalogsParams) (*delivery.CatalogsInfo, error)
